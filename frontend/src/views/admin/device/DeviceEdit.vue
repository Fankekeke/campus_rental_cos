      ...
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='物品名称' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
            { spaces: [{ required: true, message: '请输入物品名称!' }] }
            ]"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='物品类型' v-bind="formItemLayout">
            ...
            'typeId',
            { spaces: [{ required: true, message: '请输入物品类型!' }] }
            ]" style="width: 100%">
        ...
        <a-col :span="24">
          <a-form-item label='物品备注' v-bind="formItemLayout">
            <a-textarea :rows="6" v-decorator="[
            'content',
             { spaces: [{ required: true, message: '请输入物品备注!' }] }
            ]"/>
          </a-form-item>
        </a-col>
      </a-row>
